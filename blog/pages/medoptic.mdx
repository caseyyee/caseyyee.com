...
import vrApps from '../img/medoptic/vr-apps.gif';
import streamerInterface from '../img/medoptic/streamer-interface.png';
import interfaceDesign from '../img/medoptic/working.gif';
import team from '../img/medoptic/team.png';

# Medoptic Realtime VR Training Platform

<YouTubeEmbed videoId="km2YqfIjBMo" />
...
<img src={vrApps} alt="Medoptic app suite" />
...
<img src={streamerInterface} alt="Interface design" />
...
<img src={interfaceDesign} alt="Interface design" />
...
<img src={team} alt="Medoptic team" />
